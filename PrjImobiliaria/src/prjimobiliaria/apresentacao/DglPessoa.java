 ...
 * @author ale
 */
public class DglPessoa extends javax.swing.JDialog {

    /** Creates new form DglPessoa */
    public DglPessoa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DglPessoa dialog = new DglPessoa(new javax.swing.JFrame(), true);
