 ...
 * @author ale
 */
public class DglCliente extends javax.swing.JDialog {

    /** Creates new form DglPessoa */
    public DglCliente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DglCliente dialog = new DglCliente(new javax.swing.JFrame(), true);
